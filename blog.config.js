...
const BLOG = {
  ...
  FONT_AWESOME_PATH:
    'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css', // 图标库CDN ，国内推荐BootCDN，https://cdn.bootcdn.net/ajax/libs/font-awesome/5.15.4/css/all.min.css国外推荐 CloudFlare https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css
  BACKGROUND_LIGHT: '#fbf8ec', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#313131', // use hex value, don't forget '#'
  ...
  ANALYTICS_ACKEE_DOMAIN_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_DOMAIN_ID || '', // e.g 'c0b58580-fd28-4aab-ab95-58e9f4aeb3f7'

  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || '', // Remove the value or replace it with your own google site verification code

  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-3299961020495847', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
